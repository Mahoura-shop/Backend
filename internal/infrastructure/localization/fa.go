...
var Persian = map[string]interface{}{
	...
	"successMessage": map[string]interface{}{
		...
		"createBrand":               "برند با موفقیت ساخته شد.",
		"deleteBrand":               "برند با موفقیت حذف شد.",
		"updateBrand":               "برند با موفقیت به‌روز‌رسانی شد.",
		"createProduct":             "محصول با موقفیت ساخته شد.",
		"deleteProduct":             "محصول با موفقیت حذف شد.",
		"updateProduct":             "محصول با موفقیت به‌روز‌رسانی شد.",
		"updateProducts":            "محصولات با موفقیت به‌روز‌رسانی شدند.",
		"buyProducts":               "خرید محصولات با موفقیت ثبت شد.",
		"auth":                      "لطفاً پیامک های خود را بررسی کنید تا حساب خود را تأیید کرده و فرآیند ثبت نام را تکمیل نمایید.",
		...
		"payByWallet":               "پرداخت از کیف پول با موفقیت انجام شد.",
		"paymentVerified":           "پرداخت تایید و سفارش تکمیل شد.",
		"updateOrderStatus":         "وضعیت سفارش با موفقیت به‌روزرسانی شد.",
		"cancelOrder":               "سفارش با موفقیت لغو شد.",
		"flagRefund":                "سفارش برای استرداد وجه علامت‌گذاری شد.",
	},
